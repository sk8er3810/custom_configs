######################################################################
#        JaRule Mordecia's zshrc file v0.1 based on :
...
#zstyle ':vcs_info:*:prompt:*' unstagedstr '1' false
#zstyle ':vcs_info:*:prompt:*' stagedstr '2' false
#zstyle ':vcs_info:*:prompt:*' stagedstr '2' false
...
PATH=$PATH:"/cygdrive/c/Program Files (x86)/Notepad++";
...
%(!.#.$) "
# show scm info on the right side
RPROMPT="$vcs_info_msg_0_"

# show date time on right side
